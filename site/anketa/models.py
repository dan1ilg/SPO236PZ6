...
class Model_prof(models.Model):
    ...
    Professions = models.ForeignKey(Proffessia, on_delete=models.PROTECT, verbose_name="Профессия")
    Skills = models.ForeignKey(Naviki, on_delete=models.PROTECT, verbose_name="Навык")
